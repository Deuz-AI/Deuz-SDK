...
| `@deuz-sdk/core/providers` | 20 OpenAI-compat factories — Mistral, DeepSeek, Qwen, Kimi, Groq, Together, OpenRouter, Cerebras, Fireworks, GLM, MiniMax + 2.0's Perplexity, Cohere, DeepInfra, NVIDIA, SambaNova, Hyperbolic and the keyless Ollama / LM Studio — plus `createOpenAICompatible`, Azure/Bedrock re-exports and `createProviderRegistry` |
