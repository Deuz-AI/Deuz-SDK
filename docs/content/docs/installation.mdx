...
| `@deuz-sdk/core/providers` | OpenAI-compat: **Mistral, DeepSeek, Qwen, Kimi**, Groq, Together, OpenRouter, Cerebras, Fireworks, GLM, MiniMax + Azure/Bedrock re-exports + `createProviderRegistry` |
