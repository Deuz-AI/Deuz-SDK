...
> The `stepCountIs` / `hasToolCall` predicate factories exist internally but are **not** part of the public export surface. Write your `StopCondition` inline as shown above — the two examples reproduce exactly what those helpers do.
