...
React hooks over this wire are planned for Faz 6. Until then, integrate manually with `useState` and `readDeuzStream`. This consumer accumulates text, renders tool calls live, and surfaces the error part.
