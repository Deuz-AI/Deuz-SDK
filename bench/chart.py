...
def ranking_chart(theme):
    ...
    fig.suptitle("AI SDK benchmark — 16 SDKs, 5 scenarios, /100  (2026-07-20, self-assessed; rubric + sources in bench/)",
                 x=0.16, y=0.955, ha="left", fontsize=13.5, color=t["fg"], fontweight="bold")
    fig.text(0.16, 0.905, "Deuz SDK 69.6 — 14/16 overall · Chatbot 76 (T5) · community criterion scored at 336 npm downloads/week + 2 stars, no mercy",
...
def footprint_chart(theme):
    ...
    names = [r["name"].replace("@deuz-sdk/core", "@deuz-sdk/core 1.7") for r in results]
    ...
    fig.suptitle("The cost of the box — bare npm installs, measured 2026-07-20 (bench/results.json)",
